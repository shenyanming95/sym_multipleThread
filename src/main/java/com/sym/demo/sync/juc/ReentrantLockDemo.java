...
public class ReentrantLockDemo {
    ...
    public static void main(String[] args) {
        ...
        demo.printWithLockTest();
        demo.printWithStaticLockTest();
        demo.getLockByTryLockTest();
    }
     ...
     */
    private void printWithStaticLock() {
        staticLock.lock();
        try {
            if (data > -1) {
                System.out.println(Thread.currentThread().getName() + "：" + data--);
