 ...
 * </p>
 * 用CountDownLatch模拟这样一种情况：
 * 有2个运动员在等待裁判的口令起跑, 等跑到终点后告诉裁判结果, 然后裁判公布结果.
 * 可以使用2个CountDownLatch, 初始值分别为1和2, 当裁判发出起跑信号, 为1的计数器减1, 运动员起跑;
 * 每当一个运动员到终点, 为2的计数器减1,当2个运动员一起跑到终点，裁判才可以公布成绩
 *
 * @author shenyanming
