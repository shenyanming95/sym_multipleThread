...
/**
 * @Auther: shenym
 * @Date: 2019-02-18 9:41
 */
public class InterruptDemo {
    public static void main(String[] args){
        //InterruptDemo.interruptTest();
        //InterruptDemo.isInterruptedTest();
        //InterruptDemo.interruptedTest();
    }

    /**
     * Thread.interrupt()可以中断某个线程，这里的中断是将线程的中断标志设置为true
     * 分为两种情况：
    ...
    /**
     * Thread.isInterrupted()是用来获取指定线程的中断状态
     * 若线程已被中断则返回true，若线程未被中断则返回false
     * 注意：此方法不会清除线程的中断状态，仅仅只是作为一个判断而已
     */
    ...
    /**
     * Thread.interrupted()是用来获取当前线程的中断状态，当前线程已中断返回true，反之返回false
