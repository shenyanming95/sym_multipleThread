...
public class AtomicStampReferenceDemo {
     ...
     * 增加版本号, 解决ABA问题
     */
    private int initialStamp = 1;
    private AtomicStampedReference<Integer> atomicStampedReference = new AtomicStampedReference<>(10, initialStamp);
     ...
     */
    @Test
    public void ABA0Test() throws InterruptedException {
