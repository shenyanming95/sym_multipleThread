 ...
 * {@link com.sym.juc.locks} and
 * {@link com.sym.juc.atomic} packages.
 *
 * <h2>Executors</h2>
 *
 * <b>Interfaces.</b>
 *
 * {@link com.sym.juc.Executor} is a simple standardized
 * interface for defining custom thread-like subsystems, including
 * thread pools, asynchronous I/O, and lightweight task frameworks.
 * Depending on which concrete Executor class is being used, tasks may
 * execute in a newly created thread, an existing task-execution thread,
 * or the thread calling {@link com.sym.juc.Executor#execute
 * execute}, and may execute sequentially or concurrently.
 *
 * {@link com.sym.juc.ExecutorService} provides a more
 * complete asynchronous task execution framework.  An
 * ExecutorService manages queuing and scheduling of tasks,
 * and allows controlled shutdown.
 *
 * The {@link com.sym.juc.ScheduledExecutorService}
 ...
 * function expressed as {@link com.sym.juc.Callable},
 * the result-bearing analog of {@link java.lang.Runnable}.
 *
 * A {@link com.sym.juc.Future} returns the results of
 * a function, allows determination of whether execution has
 * completed, and provides a means to cancel execution.
 *
 * A {@link com.sym.juc.RunnableFuture} is a {@code Future}
 ...
 * <b>Implementations.</b>
 *
 * Classes {@link com.sym.juc.ThreadPoolExecutor} and
 * {@link com.sym.juc.ScheduledThreadPoolExecutor}
 * provide tunable, flexible thread pools.
 *
 * The {@link com.sym.juc.Executors} class provides
 * factory methods for the most common kinds and configurations
 * of Executors, as well as a few utility methods for using
 * them.  Other utilities based on {@code Executors} include the
 * concrete class {@link com.sym.juc.FutureTask}
 * providing a common extensible implementation of Futures, and
 * {@link com.sym.juc.ExecutorCompletionService}, that
 * assists in coordinating the processing of groups of
 * asynchronous tasks.
 *
 * <p>Class {@link com.sym.juc.ForkJoinPool} provides an
 * Executor primarily designed for processing instances of {@link
 * com.sym.juc.ForkJoinTask} and its subclasses.  These
 ...
 * <h2>Queues</h2>
 *
 * The {@link com.sym.juc.ConcurrentLinkedQueue} class
 * supplies an efficient scalable thread-safe non-blocking FIFO queue.
 * The {@link com.sym.juc.ConcurrentLinkedDeque} class is
 * similar, but additionally supports the {@link java.util.Deque}
 * interface.
 *
 * <p>Five implementations in {@code java.util.concurrent} support
 * the extended {@link com.sym.juc.BlockingQueue}
 * interface, that defines blocking versions of put and take:
 * {@link com.sym.juc.LinkedBlockingQueue},
 * {@link com.sym.juc.ArrayBlockingQueue},
 * {@link com.sym.juc.SynchronousQueue},
 * {@link com.sym.juc.PriorityBlockingQueue}, and
 * {@link com.sym.juc.DelayQueue}.
 * The different classes cover the most common usage contexts
 * for producer-consumer, messaging, parallel tasking, and
 * related concurrent designs.
 *
 * <p>Extended interface {@link com.sym.juc.TransferQueue},
 * and implementation {@link com.sym.juc.LinkedTransferQueue}
 * introduce a synchronous {@code transfer} method (along with related
 * features) in which a producer may optionally block awaiting its
 * consumer.
 *
 * <p>The {@link com.sym.juc.BlockingDeque} interface
 * extends {@code BlockingQueue} to support both FIFO and LIFO
 * (stack-based) operations.
 * Class {@link com.sym.juc.LinkedBlockingDeque}
 * provides an implementation.
 *
 * <h2>Timing</h2>
 *
 * The {@link com.sym.juc.TimeUnit} class provides
 ...
 * <ul>
 *
 * <li>{@link com.sym.juc.Semaphore} is a classic concurrency tool.
 *
 * <li>{@link com.sym.juc.CountDownLatch} is a very simple yet
 * very common utility for blocking until a given number of signals,
 * events, or conditions hold.
 *
 * <li>A {@link com.sym.juc.CyclicBarrier} is a resettable
 * multiway synchronization point useful in some styles of parallel
 * programming.
 *
 * <li>A {@link com.sym.juc.Phaser} provides
 * a more flexible form of barrier that may be used to control phased
 * computation among multiple threads.
 *
 * <li>An {@link com.sym.juc.Exchanger} allows two threads to
 ...
 * {@link com.sym.juc.ConcurrentHashMap},
 * {@link com.sym.juc.ConcurrentSkipListMap},
 * {@link com.sym.juc.ConcurrentSkipListSet},
 * {@link com.sym.juc.CopyOnWriteArrayList}, and
 * {@link com.sym.juc.CopyOnWriteArraySet}.
 ...
 * com.sym.juc.ConcurrentHashMap} is "concurrent".  A
